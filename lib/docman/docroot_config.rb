...
module Docman
  ...
  class DocrootConfig
    ...
    def override_from_environment(info)
      ...
      docman_repo_var = "COMPONENT_REPO_#{info['name'].upcase}"
      ...
      docman_order_var = "COMPONENT_ORDER_#{info['name'].upcase}"
      ...
      docman_version_var = "COMPONENT_VERSION_#{info['name'].upcase}"
